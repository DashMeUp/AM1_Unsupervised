...
def collab_model(movie_list,top_n=10):
    ...
    movie_list=["".join(movie_list[0][:0]),"".join(movie_list[1][:0]),"".join(movie_list[2][:0])]
    ...
    idx_1 = check("".join(movie_list[0][:0]),indices)
    idx_2 = check("".join(movie_list[1][:0]),indices)
    idx_3 = check("".join(movie_list[2][:0]),indices)
